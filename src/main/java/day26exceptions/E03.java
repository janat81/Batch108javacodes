...
public class E03 {
    ...
    /*
        ...
        9) What is the difference between exception and error
           exception can be handled but error can not
    ...
    //If the path is wrong, if the file does not exist, if the text can not be read stop execution
    ...
    //Create a method to read a text from a text file
    //If the path is wrong,give a message to the user and do not stop the execution
    // if the file does not exist, give a message to the user and do not stop the execution
    // if the text can not be read,give a message to the user stop execution
