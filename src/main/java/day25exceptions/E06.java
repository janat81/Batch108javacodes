...
public class E06 {
    ...
    public static void main(String[] args) {
        ...
        doCombo("5612",2);//str.length(); will throw NullPointerException,execution will be stopped in line 16
        doCombo("12a",2); //Integer.valueOf(str); will throw NumberFormatException, execution will be stopped in line 21
        doCombo("420",0);// will throw ArithmeticException, execution will be stopped in line 24
    }
