...
public class E03 {
    public static void main(String[] args) {
        ...
        int r3 = getNumOfChars(null); // Null pointer exception: If you use length() method with null you will get NullPointer Exception
    ...
    public static int getNumOfChars(String str){
        ...
        try {
            ...
            System.out.println("A problem ocurred in using length()");
        }
      return numOfChar;
    }
}
