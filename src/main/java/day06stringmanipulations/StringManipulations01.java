...
public class StringManipulations01 {
    ...
    public static void main(String[] args) {
       ...
       char lastChar = str.charAt(str.length()-1);
        ...
        System.out.println(firstChar+lastChar); //162 => 65+97 If you use char  data in a math operation Java uses ASCII values

        System.out.println(""+firstChar+lastChar);//When you put empty string at the beginning it will be concatenation operation and you will get String

        //2.Way: By using substring()
        String firstCharacter = str.substring(0,1); // substring(0,1) always gives you first character
        ...
        //3.Example: Type code to get initials of the first name and the last name of a given name. Ali Can ==> AC, Mary Star ==> MC
        ...
        //4.Example: Type code to find the number of words in a string. "I like to move it, move it" ==>
