...
public class StringManipulations02 {
    ...
    public static void main(String[] args) {
        ...
        //Example 1: Type code to see the order number of the first occurence  of the character 'a'
        //           " I want to learn Java "
        String str = "I want to learn Java";
        int idx = str.indexOf('a'); //indexOf() method gives you the index of first occurence of a specific character
        System.out.println(idx+1); //4

        //Example 2: Type code to see the order number of the first occurence of "Java"
        ...
        //Example 4: Type code to find the order number of last occurrence of "Java" in the sentence
